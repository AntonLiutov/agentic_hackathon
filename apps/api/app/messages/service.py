    ...
    *,
    ...
    return (
        select(
            ...
            case(
                (author.c.deleted_at.is_not(None), "Deleted user"),
                else_=func.coalesce(author.c.username, "Deleted user"),
            ),
            ...
            reply_message.c.id,
            case(
                (reply_author.c.deleted_at.is_not(None), "Deleted user"),
                else_=func.coalesce(reply_author.c.username, "Deleted user"),
            ),
